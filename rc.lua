...
-- Hotkeys Awesome
    ...
    -- Tag browsing alt + contol
    awful.key({ altkey, "Control" }, "Left", awful.tag.viewprev,
        { description = "view previous gnome style", group = "tag" }),
    awful.key({ altkey, "Control" }, "Right", awful.tag.viewnext,
        { description = "view next gnome style", group = "tag" }),

    -- Tag browsing alt + contol
    awful.key({ altkey, "Control" }, "h", awful.tag.viewprev,
        { description = "view previous vim style", group = "tag" }),
    awful.key({ altkey, "Control" }, "l", awful.tag.viewnext,
        { description = "view next vim style", group = "tag" }),
  ...
  -- Launcher
    ...
    awful.key({ "Control" }, ";", function() awful.util.spawn("rofi -show") end,
        { description = "Run Rofi launcher r", group = "launcher" }),

  -- keybinding: press super + control + h to open Default
    awful.key({ modkey, "Control" }, "h",
      function()
          awful.keygrabber.run(function(mod, key, event)
                  awful.spawn("google-chrome --profile-directory=Default")
                  awful.keygrabber.stop()
          end)
      end,
      { description = "Hastycode Profile", group = "launcher" }),

  -- keybinding: press super + control + l to open Default
    awful.key({ modkey, "Control" }, "l",
      function()
          awful.keygrabber.run(function(mod, key, event)
                  awful.spawn("google-chrome --profile-directory='Profile 1'")
                  awful.keygrabber.stop()
          end)
      end,
      { description = "Andreh Profile", group = "launcher" }),
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, }, "q", function(c) c:kill() end,
        { description = "close with modkey", group = "hotkeys" }),
    awful.key({ "Control" }, "x", function(c) c:kill() end,
        { description = "close with X", group = "hotkeys" }),
...
client.connect_signal("manage", function(c)
    ...
    if c.class == "Google-chrome" and not c:isvisible() then
